                                        ...
                                        <div class="row">
                                            <div class="col-lg-2 col-md-3">
                                                ...
                                                <div class="list-group">
                                                    ...
                                                    <a href="<?php echo base_url().'admin/stock/view' ?>" class="list-group-item"><?php echo get_phrase('supplied'); ?><span class="badge green"><?=$count_stock?></span></a>
                                                    <a href="<?php echo base_url().'admin/outstandings/purchases' ?>" class="list-group-item"><?php echo get_phrase('outstandings'); ?><span class="badge orange"><?=$count_outstandings?></span></a>
...
?>
                                            ...
                                            <a href="<?php echo base_url().'admin/suppliers/view' ?>" class="btn btn-default"><i class="fa fa-arrow-circle-left"></i> <?php echo get_phrase('back_to_suppliers'); ?></a>
                                        <hr>
                                            ...
                                            <div class="col-sm-9">
                                                <div id="userSettingsContent" class="tab-content">
                                                    <div class="tab-pane fade in active" id="basicInformation">
                                                        <form role="form" action="<?php echo base_url().'admin/suppliers/update_supplier/'.$id?>" method="post">
                                                    ...
                                                    <div class="tab-pane fade" id="profilePicture">
                                                        ...
                                                        <img class="img-responsive img-profile"  src="<?php echo $this->crud->get_image_url('supplier',$id);?>" alt="">
                                                        <br>
                                                        <form role="form" action="<?php echo base_url().'admin/suppliers/update_image/'.$id?>" method="post" enctype="multipart/form-data">
                                                            <div class="form-group">
