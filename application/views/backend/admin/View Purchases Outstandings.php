                            ...
                            <div class="portlet-body">
                                ...
                                <div class="row">
                                    <div class="col-lg-12">
                                        ...
                                        <!-- /.table-responsive -->
                                        <a href="#"  onclick="showAjaxModalSmall('<?php echo base_url();?>admin/stock/payment/<?php echo $purchase_id;?>')" class="btn btn-green"><i class="fa fa-rub"></i> <?php echo get_phrase('pay_now'); ?></a>
                                ...
                                <!-- /.row -->
                                    ...
                                    <div class="col-lg-3">
                                        <a href="<?php echo base_url().'admin/outstandings/purchases' ?>" class="btn btn-default"><i class="fa fa-arrow-circle-left"></i> <?php echo get_phrase('back_to_po'); ?></a>
                                        <hr>
