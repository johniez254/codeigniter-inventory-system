                            ...
                            <div class="portlet-body">
								...
								//count
                                        ...
                                        <ul class="dropdown-menu" role="menu" style="text-align:left; widows:20px;">
                                        	<li><a href="<?php echo base_url();?>admin/purchases/view_purchases/<?php echo urlencode(base64_encode(urlencode(base64_encode(urlencode(base64_encode(urlencode(base64_encode($pid))))))))?>;"><small><i class="fa fa-book"></i> <?php echo get_phrase('view_details'); ?></small></a>
                                            </li>
                                            <?php if($due>0){?>
