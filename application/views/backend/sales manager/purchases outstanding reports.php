                        ...
                        <div class="portlet portlet-default">
                            <div class="portlet-heading">
                                <div class="portlet-title">
                                    <h4><?php echo get_phrase('purchases_outstanding_reports');?></h4>
                                </div>
                            ...
                            <div id="areaChart" class="panel-collapse collapse in">
                                ...
                                <center>
                                <h3><?php echo get_phrase('report_select_po');?></h3>
                                <form class="form-inline" role="form" method="get" action="<?php echo base_url().'salesManager/reports/purchases_outstanding_reports' ?>">
                                        ...
                                        <div id="printer">
                                            ...
                                            <center><h4><?php echo get_phrase('purchases_outstanding_reports');?> <?php echo get_phrase('from');?>&nbsp;<b><?php echo $_GET['from'] ?></b>&nbsp;<?php echo get_phrase('to');?>&nbsp;<b><?php echo $_GET['to'] ?></b></h4></center>
									  ...
									  $query = $this->db->query("select * from purchases where due>='1' AND purchase_date BETWEEN ".$d1." and ".$d2."");

										foreach ($query->result() as $row){
											$i='1';
											$purchase_id=$row->purchase_id;
        									$supplier_id=$row->supplier_id;
        									$on=$phone=$row->purchase_no;
										...
										?>
                                        	<tr>
                                                ...
                                                <td><?php echo date('d'.'/'.'M'.'/'.'Y',$purchase_date); ?></td>
