                            ...
                            <div class="portlet-body">
                                ...
                                <div class="row">
                                    <div class="col-lg-12">
                                        ...
                                        <!-- /.table-responsive -->
                                        <a href="#"  onclick="showAjaxModalSmall('<?php echo base_url();?>salesManager/sales/payment/<?php echo $order_id;?>')" class="btn btn-green"><?php echo get_phrase('pay_now'); ?></a>
                                ...
                                <!-- /.row -->
                                    ...
                                    <div class="col-lg-3">
                                        <a href="<?php echo base_url().'salesManager/outstandings/sales' ?>" class="btn btn-default"><i class="fa fa-arrow-circle-left"></i> <?php echo get_phrase('back_to_so'); ?></a>
                                        <hr>
                                    ...
                                    <hr>
                                        ...
                                        <ul class="nav nav-pills nav-stacked">
                                            ...
                                            <li><a href="<?php echo base_url().'salesManager/stock/view' ?>"><?php echo get_phrase('stock'); ?></a>
                                            </li>
                                            <li><a href="<?php echo base_url().'salesManager/suppliers/view' ?>"><?php echo get_phrase('suppliers'); ?></a>
                                            </li>
                                        </ul>
                                    </div>
