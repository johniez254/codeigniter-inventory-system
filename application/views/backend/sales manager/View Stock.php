                ...
                <div class="row">
                    ...
                    <a href="#">
                        <img class="img-responsive img-profile" src="<?php echo $this->crud->get_image_url('stock',$stock_id);?>"  alt="">
                                    ...
                                    <div class="col-lg-3">
                                      <br /><br /><br /><br />
                                        <a href="<?php echo base_url().'salesManager/stock/view' ?>" class="btn btn-default btn-block"><i class="fa fa-arrow-circle-left"></i> Bact To Stock</a>
                                        <hr>
                                        ...
                                        <ul class="nav navbar-nav button-tooltips">
                                            <li class="message-actions">
                                                <div class="btn-group navbar-btn">
                                                    ...
                                                    <button type="button" class="btn btn-white" data-toggle="tooltip" data-placement="bottom" title="Edit Price" onclick="showAjaxModalSmall('<?php echo base_url();?>salesManager/stock/edit/<?php echo $stock_id;?>');"><i class="fa fa-edit"></i>
                                                    </button>
                                        ...
                                        <ul class="nav nav-pills nav-stacked">
                                            <li><a href="<?php echo base_url().'salesManager/purchases/view' ?>">Purchases</a>
                                            </li>
                                            <li><a href="<?php echo base_url().'salesManager/sales/view' ?>">Sales</a>
                                            </li>
                                            <li><a href="<?php echo base_url().'salesManager/outstandings/sales'?>">Sales outstandings</a>
                                            </li>
                                            <li><a href="<?php echo base_url().'salesManager/outstandings/purchases'?>">Purchases outstandings</a>
                                            </li>
                                        </ul>
                                    </div>
