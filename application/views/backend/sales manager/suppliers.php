                            ...
                            <?php
                                ...
                                <div id="myTabContent" class="tab-content">
                                    ...
                                    <div class="pull-right button-tooltips">
                                         ...
                                         <a href="<?php echo base_url().'salesManager/downloads/suppliers/excel' ?>" class="btn btn-white" data-toggle="tooltip" data-placement="top" title="Excel"><i class="fa fa-table"></i>
                                                    </a>
                                         <a href="<?php echo base_url().'salesManager/downloads/suppliers/pdf' ?>" target="_blank" class="btn btn-white" data-toggle="tooltip" data-placement="top" title="pdf"><i class="fa fa-download"></i>
                                                    </a>
                                    	</div>
                                    </div>
                                ...
                                foreach($desc as $row):
                                        ...
                                        <ul class="dropdown-menu" role="menu">
                                            <li><a href="#" onclick="showAjaxModal('<?php echo base_url();?>salesManager/suppliers/edit/<?php echo $sid;?>');"><small><i class="fa fa-edit"></i> <?php echo get_phrase('edit_details'); ?></small></a>
                                            </li>
                                            <li>
                                              <a href="<?php echo base_url().'salesManager/suppliers/view_details/'.urlencode(base64_encode(urlencode(base64_encode(urlencode(base64_encode(urlencode(base64_encode($sid)))))))).'' ?>"><small><i class="fa fa-arrow-circle-right"></i> <?php echo get_phrase('view_details'); ?></small></a>
                                            </li>
                                            <?php /*?><li><a href="#" onclick="confirm_modal('<?php echo base_url();?>salesManager/suppliers/delete/<?php echo $sid;?>');"><small><i class="fa fa-trash-o"></i> <?php echo get_phrase('delete'); ?></small></a>
                                            </li><?php */?>
                                        </ul>
                                    </div>
                                    <!-- /btn-group -->
                                    ...
                                    <div class="tab-pane fade" id="profile">
                                        ...
                                        <div class="col-lg-8">
                                        	 <?php $at = array("name" => "form","encytype"=>"multipart/form-data");
           									 echo form_open_multipart(base_url() .'salesManager/suppliers/add_supplier', $at);?>
