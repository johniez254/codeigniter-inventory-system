...
?>
            ...
            echo form_open("salesManager/profile/update/".$pid, $attributes);?>
                   ...
                   <?php echo form_close()?>
                                    ...
                                    <div class="tab-pane fade" id="profile">
                                        ...
                                        <!--password-->
                                         ...
                                         <?php $attributes = array("name" => "form", 'enctype' => 'multipart/form-data');
            echo form_open("salesManager/profile/pass/".$sess_id, $attributes);?>
                 ...
                 <?php 
								...
								?>
                                    ...
                                    <div class="tab-pane fade" id="security">
                                        ...
                                        <p>You have not yet set up your security question. You are Recommended To do that. Incase you lose your password, it will help you to recover your password.</p>
                                        <a href="<?=base_url().'salesManager/security_question/security'?>" class="btn btn-green btn-sm">Setup now?</a>
                                        <?php }else{ ?>
                                        ...
                                        <a href="<?=base_url().'salesManager/security_question/security'?>" class="btn btn-green btn-sm">Edit now?</a>
                                        <?php }?>
                                    </div>
                                </div>
...
?>
            ...
            echo form_open_multipart(base_url() .'salesManager/profile/update_image/'.$sess_id.'', $at);?>
                                                            <div class="form-group">
