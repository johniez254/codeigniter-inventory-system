...
?>
  ...
  <!-- begin DASHBOARD CIRCLE TILES -->
                <div class="row">
                <?php //$d=strtotime('now +1 hour'); //echo $d;
                ...
                <?php if($quiz=='1' or $quiz=='2'): ?>
                	<div class="col-lg-12">
                    	 <div class="alert alert-info alert-dismissable">
                            ...
                            <strong><i class="fa fa-info-circle"></i> Info Alert:</strong> You have not yet set your security Question. To set your security question, <b><a href="<?php echo base_url().'salesManager/security_question/security' ?>"><i class="fa fa-hand-o-right"></i> Click here...</a></b>
                      	</div>
                    ...
                    <div class="col-xs-6 col-sm-3">
                        <div class="circle-tile">
                            ...
                            <div class="circle-tile-content dark-blue">
                                ...
                                <a href="<?php echo base_url()."salesManager/suppliers/view" ?>" class="circle-tile-footer">More Info <i class="fa fa-chevron-circle-right"></i></a>
                            </div>
                        </div>
                    </div>
                    <div class="col-xs-6 col-sm-3">
                        <div class="circle-tile">
                            ...
                            <div class="circle-tile-content green">
                                ...
                                <a href="<?php echo base_url()."salesManager/sales/view" ?>" class="circle-tile-footer">More Info <i class="fa fa-chevron-circle-right"></i></a>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-xs-6 col-sm-3">
                        <div class="circle-tile">
                            ...
                            <div class="circle-tile-content blue">
                                ...
                                <div class="circle-tile-number text-faded">
                                                                    <?php
$ol="deleted_purchase=0";
$this->db->select('*');
$this->db->from('purchases');
$this->db->where($ol);
$purchases	=	$this->db->count_all_results();

echo $purchases;
?>
                                </div>
                                <a href="<?php echo base_url().'salesManager/stock/view' ?>" class="circle-tile-footer">More Info <i class="fa fa-chevron-circle-right"></i></a>
                            </div>
                        </div>
                    </div>
                    <div class="col-xs-6 col-sm-3">
                            ...
                            <small><?php echo $p; ?> Event</small>
                             <label class="selected">
                               ...
                               <small><?php echo $p; ?> Event</small>
                                ...
                                <hr />
                        <?php endforeach ?>
                        <a href="<?php echo base_url().'salesManager/events/view' ?>" class="btn btn-white btn-block btn-xs"><i  class="fa fa-arrow-circle-right"></i> View All Events Details</a>
                    </div>
                    </div>
