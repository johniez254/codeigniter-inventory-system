                        ...
                        <div class="portlet portlet-default">
                            <div class="portlet-heading">
                                <div class="portlet-title">
                                    <h4><?php echo get_phrase('stock_reports'); ?></h4>
                                </div>
                                <div class="clearfix"></div>
                            </div>
                            <div class="portlet-body">
                                <ul id="myPills" class="nav nav-pills" style="background-color:#f5f5f5;">
                                    <li class="active"><a href="#pillHome" data-toggle="tab"><?php echo get_phrase('available_stock'); ?></a>
                                    </li>
                                    <li><a href="#pillProfile" data-toggle="tab"><?php echo get_phrase('low_stock'); ?></a>
                                    </li>
                                    <li><a href="#damaged" data-toggle="tab"><?php echo get_phrase('damaged_stock'); ?></a>
                                    </li>
                                    
                                    <li><a href="#sold" data-toggle="tab"><?php echo get_phrase('sold_stock'); ?></a>
                                    </li>
                                </ul>
                                <hr />
