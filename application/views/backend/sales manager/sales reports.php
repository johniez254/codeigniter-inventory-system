                        ...
                        <div class="portlet portlet-default">
                            <div class="portlet-heading">
                                <div class="portlet-title">
                                    <h4><?php echo get_phrase('sales_reports'); ?></h4>
                                </div>
                            ...
                            <div id="areaChart" class="panel-collapse collapse in">
                                ...
                                <center>
                                <h3><?php echo get_phrase('report_select_sales');?></h3>
                                <form class="form-inline" role="form" method="get" action="<?php echo base_url().'salesManager/reports/sales_reports' ?>">
                                                <div class="form-group">
                                                    <label class="sr-only" for="from"><?php echo get_phrase('from');?></label>
                                        ...
                                        <div id="printer">
                                            ...
                                            <center><h4><?php echo get_phrase('sales_reports');?> <?php echo get_phrase('from');?>&nbsp;<b><?php echo $_GET['from'] ?></b>&nbsp;<?php echo get_phrase('to');?>&nbsp;<b><?php echo $_GET['to'] ?></b></h4></center>
									  ...
									  $query = $this->db->query("select * from orders where order_date BETWEEN ".$d1." and ".$d2."");
										...
										?>
                                        	<tr>
                                                ...
                                                <td class="text-right">0<?php echo $phone; ?></td>
