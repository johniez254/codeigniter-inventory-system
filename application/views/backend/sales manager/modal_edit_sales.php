...
?>
<?php endforeach;?>
<center><h3><i class="fa fa-edit"></i> <?php echo get_phrase('edit'); ?> <?php echo get_phrase('sales_outstandings'); ?></h3></center>
<hr>
<?php $attributes = array("name" => "form", 'enctype' => 'multipart/form-data');
            echo form_open("salesManager/stock/sales_update/".$id, $attributes);?>
