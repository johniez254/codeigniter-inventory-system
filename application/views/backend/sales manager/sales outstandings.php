                        ...
                        <div class="portlet portlet-default">
                            ...
                            <div class="portlet-body">
                                    ...
                                    <div class="pull-right button-tooltips">
                                         ...
                                         <a href="<?php echo base_url().'salesManager/downloads/sales_outstandings/excel' ?>" class="btn btn-white" data-toggle="tooltip" data-placement="top" title="Excel"><i class="fa fa-table"></i>
                                                    </a>
                                         <a href="<?php echo base_url().'salesManager/downloads/sales_outstandings/pdf' ?>" target="_blank" class="btn btn-white" data-toggle="tooltip" data-placement="top" title="pdf"><i class="fa fa-download"></i>
                                                    </a>
                                    	</div>
                                    </div>
                                    <?php } ?>
								...
								//count
                                        ...
                                        <ul class="dropdown-menu" role="menu" style="text-align:left; widows:20px;">
                                        	<li><a href="<?php echo base_url();?>salesManager/outstandings/view_sales/<?php echo urlencode(base64_encode(urlencode(base64_encode(urlencode(base64_encode(urlencode(base64_encode($id))))))))?>;"><small><i class="fa fa-book"></i> <?php echo get_phrase('view_details'); ?></small></a>
                                            </li>
                                            <li><a href="#" onclick="showAjaxModalSmall('<?php echo base_url();?>salesManager/sales/payment/<?php echo $id;?>');"><small><i class="fa fa-rub"></i> <?php echo get_phrase('pay_now'); ?></small></a>
                                            </li>
