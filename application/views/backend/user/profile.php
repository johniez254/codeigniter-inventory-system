...
?>
            ...
            echo form_open("user/profile/update/".$pid, $attributes);?>
								...
								echo form_input($data);
								 ...
								 ?>
                                      <span class="help-block"><?php echo form_error('username'); ?></span>
                                                    ...
                                                    <input type="number" class="form-control" placeholder="<?php echo get_phrase('phone'); ?>" name="phone" autocomplete="off" value="<?php echo $phone; ?>" maxlength="9" id="basicMax">
                <?php /*?> <?php 
								$data=array(
								'name'=> 'phone',
								'type'=>'text',
                   ...
                   <?php echo form_close()?>
                                    ...
                                    <div class="tab-pane fade" id="profile">
                                        ...
                                        <!--password-->
                                         ...
                                         <?php $attributes = array("name" => "form", 'enctype' => 'multipart/form-data');
            echo form_open("user/profile/pass/".$sess_id, $attributes);?>
                 ...
                 <?php 
								...
								?>
                                    ...
                                    <div class="tab-pane fade" id="security">
                                        ...
                                        <p>You have not yet set up your security question. You are Recommended To do that. Incase you lose your password, it will help you to recover your it back.</p>
                                        <a href="<?=base_url().'user/security_question/security'?>" class="btn btn-green btn-sm">Setup now?</a>
                                        <?php }else{ ?>
                                        ...
                                        <a href="<?=base_url().'user/security_question/security'?>" class="btn btn-green btn-sm">Edit now?</a>
                                        <?php }?>
                                    </div>
                                </div>
...
?>
                 ...
                 <?php 
								...
								?>
                                    ...
                                    <div class="tab-pane fade" id="security">
                                    	<h3>Hi? <?=$username?>,</h3>
                                        <?php if($quiz=='1' or $quiz=='2'){ ?>
                                        <p>You have not yet set up your security question. You are Recommended To do that. Incase you lose your password, it will help you to recover it back.</p>
                                        <a href="<?=base_url().'user/security_question/security'?>" class="btn btn-green btn-sm">Setup now?</a>
                                        <?php }else{ ?>
                                        <p>You have already setup your security question. You are good to go. You can however edit your security question details if you want to.</p>
                                        <p><b>Your question : </b><span class="text-blue"><?=$quiz?></span></p>
            ...
            echo form_open_multipart(base_url() .'user/profile/update_image/'.$sess_id.'', $at);?>
                                                            <div class="form-group">
