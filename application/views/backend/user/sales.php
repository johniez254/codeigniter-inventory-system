                        ...
                        <div class="portlet portlet-default">
                            ...
                            <div class="portlet-body">
                                <ul id="myTab" class="nav nav-tabs">
                                    <li class="active"><a href="#home" data-toggle="tab"><i class="fa fa-shopping-cart"></i> Sales</a>
                                    </li>
                                    <li><a href="#profile" data-toggle="tab"><i class="fa fa-plus-circle"></i> Add New Sales</a>
                                    </li>
                                </ul>
                                <div id="myTabContent" class="tab-content">
                                    <div class="tab-pane fade in active" id="home">
                                        ...
                                        <div class="pull-right button-tooltips">
                                         ...
                                         <?php /*?><a href="<?php echo base_url().'user/downloads/sales/excel' ?>" class="btn btn-white" data-toggle="tooltip" data-placement="top" title="Excel"><i class="fa fa-table"></i>
                                                    </a><?php */?>
                                         <a href="<?php echo base_url().'user/downloads/sales/pdf' ?>" target="_blank" class="btn btn-white" data-toggle="tooltip" data-placement="top" title="pdf"><i class="fa fa-download"></i>
                                                    </a>
                                    	</div>
                                    </div>
								...
								//count
                                        ...
                                        <ul class="dropdown-menu" role="menu" style="text-align:left;">
                                        	<li><a href="<?php echo base_url().'user/orders/view_order/'.urlencode(base64_encode(urlencode(base64_encode(urlencode(base64_encode(urlencode(base64_encode($order_id)))))))).'' ?>"><small><i class="fa fa-arrow-circle-right"></i> View Sales</small></a>
                                            </li>
                                        </ul>
                                    </div>
                                                </td>
