                    ...
                    <div class="col-lg-12">
                        ...
                        <div class="portlet portlet-default">
                            <div class="portlet-body">
                                ...
                                <div id="printer">
                                    <div class="col-lg-9">
                                        <h3>Sales Outstanding Invoice # <?=$order_no?></h3>
                                        <hr>
                                ...
                                <div class="row">
                                    <div class="col-lg-12">
                                        <h3>Items Sold (<?php echo $count; ?>)</h3>
                                        ...
                                        <!-- /.table-responsive -->
                                        <a href="#"  onclick="showAjaxModalSmall('<?php echo base_url();?>user/sales/payment/<?php echo $order_id;?>')" class="btn btn-green">Add Payment Outstanding</a>
                                        <a class="btn btn-blue" onclick="printDiv('printer')"><i class="fa fa-print"></i> Print Details</a>
                                    </div>
                                </div>
                                <!-- /.row -->
                                    ...
                                    <div class="col-lg-3">
                                        <a href="<?php echo base_url().'user/outstandings/sales' ?>" class="btn btn-default">Back to Sales Outstandings</a>
                                        <hr>
                                    ...
                                    <hr>
                                        ...
                                        <ul class="nav nav-pills nav-stacked">
                                            ...
                                            <li><a href="<?php echo base_url().'user/stock/view' ?>">Stock</a>
                                            </li>
                                            <li><a href="<?php echo base_url().'user/user/sales/view' ?>">Sales</a>
                                            </li>
                                            <li><a href="<?php echo base_url().'user/reports/view' ?>">Reports</a>
                                            </li>
                                        </ul>
                                    </div>
