                        ...
                        <div class="portlet portlet-default">
                            <div class="portlet-heading">
                                <div class="portlet-title">
                                    <h4>Sales Outstanding Reports</h4>
                                </div>
                            ...
                            <div id="areaChart" class="panel-collapse collapse in">
                                ...
                                <center>
                                <h3>Select Date To View Sales Outstanding Reports</h3>
                                <form class="form-inline" role="form" method="get" action="<?php echo base_url().'user/reports/sales_outstanding_reports' ?>">
