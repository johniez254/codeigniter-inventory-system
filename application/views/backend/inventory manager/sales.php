                            ...
                            <div class="portlet-body">
                                ...
                                <div id="myTabContent" class="tab-content">
                                    <div class="tab-pane fade in active" id="home">
                                        <!--table class responsive-->
                                         ...
                                         <a href="<?php echo base_url().'manager/downloads/sales/pdf' ?>" target="_blank" class="btn btn-white" data-toggle="tooltip" data-placement="top" title="pdf"><i class="fa fa-download"></i>
                                                    </a>
                                    	</div>
                                    </div>
								...
								//count
                                        ...
                                        <ul class="dropdown-menu" role="menu" style="text-align:left;">
                                        	<li><a href="<?php echo base_url().'manager/sales/view_sales/'.urlencode(base64_encode(urlencode(base64_encode(urlencode(base64_encode(urlencode(base64_encode($order_id)))))))).'' ?>"><small><i class="fa fa-arrow-circle-right"></i> <?php echo get_phrase('view_sales'); ?></small></a>
                                            </li>
                                        </ul>
                                    </div>
                                                </td>
