...
<!-- Basic Tabs Example -->
                <div class="row">
                    <div class="col-lg-12">
                        ...
                        <a href="#" onclick="get_stock(<?php echo 'id='.$id.''; ?>);"><button type="button" class="btn btn-default btn-xs" data-toggle="tooltip" data-placement="top" title="View Category"><i class="fa fa-book"></i></button></a>
                                                <a href="#" onclick="showAjaxModalSmall('<?php echo base_url();?>manager/category/edit/<?php echo $id;?>')"><button type="button" class="btn btn-blue btn-xs" data-toggle="tooltip" data-placement="top" title="Edit"><i class="fa fa-edit"></i></button></a>  
                                                <a href="#" onclick="confirm_modal('<?php echo base_url();?>manager/category/delete/<?php echo $id;?>')"><button type="button" class="btn btn-red btn-xs" data-toggle="tooltip" data-placement="top" title="Delete"><i class="fa fa-trash-o"></i></button></a>                      
            ...
            echo form_open("manager/category/add", $attributes);?>
