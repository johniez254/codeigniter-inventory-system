                ...
                <div class="row">
                    ...
                    <a href="#">
                        <img class="img-responsive img-profile" src="<?php echo $this->crud->get_image_url('stock',$stock_id);?>"  alt="">
                                    ...
                                    <div class="col-lg-3">
                                      <br /><br /><br /><br />
                                        <a href="<?php echo base_url().'manager/stock/view' ?>" class="btn btn-default btn-block"><i class="fa fa-arrow-circle-left"></i> Bact To Stock</a>
                                        <hr>
                                        ...
                                        <ul class="nav navbar-nav button-tooltips">
                                            <li class="message-actions">
                                                <div class="btn-group navbar-btn">
                                                	<button type="button" class="btn btn-white" data-toggle="tooltip" data-placement="bottom" title="Edit Details" onclick="showAjaxModal('<?php echo base_url();?>manager/stock/edit/<?php echo $stock_id;?>');"><i class="fa fa-edit"></i>
                                                    </button>
                                                    ...
                                                    <button type="button" class="btn btn-white" data-toggle="tooltip" data-placement="bottom" title="Mark Damaged" onclick="showAjaxModalSmall('<?php echo base_url();?>manager/stock/damage/<?php echo $stock_id;?>');"><i class="fa fa-exclamation-circle"></i>
                                                    </button>
                                                    <button type="button" class="btn btn-white" data-toggle="tooltip" data-placement="bottom" title="Delete" onclick="confirm_modal('<?php echo base_url();?>manager/stock/delete/<?php echo $stock_id;?>');"><i class="fa fa-trash-o"></i>
                                                    </button>
                                                </div>
                                            </li>
                                        </ul>
                                        ...
                                        <ul class="nav nav-pills nav-stacked">
                                            <li><a href="<?php echo base_url().'manager/stock/view' ?>">Manage Stock</a>
                                            </li>
                                            <li><a href="<?php echo base_url().'manager/descriptions/view' ?>">Manage Descriptions</a>
                                            </li>
                                            <li><a href="<?php echo base_url().'manager/category/view'?>">Manage Categories</a>
                                            </li>
                                        </ul>
                                    </div>
