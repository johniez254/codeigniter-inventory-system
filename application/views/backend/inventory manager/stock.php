                        ...
                        <div class="portlet portlet-default">
							...
							?>
                                <ul id="myTab" class="nav nav-tabs">
                                    ...
                                    <li><a href="#profile" data-toggle="tab"><i class="fa fa-pencil"></i> Update Bulk stock</a>
                                    </li><?php /*?>
                                ...
                                <div id="myTabContent" class="tab-content">
                                    <div class="tab-pane fade in active" id="home">
                                        ...
                                        <!--stock table-->
                                         ...
                                         <?php /*?><a href="<?php echo base_url().'manager/downloads/stock/excel' ?>" class="btn btn-white" data-toggle="tooltip" data-placement="top" title="Excel"><i class="fa fa-table"></i>
                                                    </a><?php */?>
                                         <a href="<?php echo base_url().'manager/downloads/stock/pdf' ?>" target="_blank" class="btn btn-white" data-toggle="tooltip" data-placement="top" title="pdf"><i class="fa fa-download"></i>
                                                    </a>
                                    	</div>
                                    </div>
								...
								?>
                                        ...
                                        <ul class="dropdown-menu" role="menu" style="text-align:left;">
                                        	<li><a href="<?php echo base_url().'manager/stock/view_stock/'.urlencode(base64_encode(urlencode(base64_encode(urlencode(base64_encode(urlencode(base64_encode($id)))))))) ?>"><small><i class="fa fa-book"></i> View Details</small></a>
                                            </li>
                                        	<li><a href="#" onclick="showAjaxModal('<?php echo base_url();?>manager/stock/edit/<?php echo $id;?>');"><small><i class="fa fa-edit"></i> Edit Details</small></a>
                                            </li>
                                            <li><a href="#" onclick="showAjaxModalSmall('<?php echo base_url();?>manager/stock/damage/<?php echo $id;?>');"><small><i class="fa fa-tasks"></i> Mark Damaged</small></a>
                                            </li>
                                            <li><a href="#" onclick="confirm_modal('<?php echo base_url();?>manager/stock/delete/<?php echo $id;?>');"><small><i class="fa fa-trash-o"></i> Delete</small></a>
                                            </li>
                                        </ul>
                                    </div>
                                    </center>
...
<?php /*?>                                       
                                    <div class="success-messages"></div>
                                     <!--/success-messages-->
                                        ...
                                        <form class="form-horizontal" method="POST" action="<?php echo base_url().'manager/stock/add_stock' ?>" id="createPurchaseForm">
...
<script>
<?php /*?>//function for adding orders rows
function addPurchaseRow() {
	...
	$.ajax({
		url: '<?php echo base_url()?>manager/category/select_category',
		type: 'post',
		dataType: 'json',
