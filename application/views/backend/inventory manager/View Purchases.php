                    ...
                    <div class="col-lg-12">
                        ...
                        <div class="portlet portlet-default">
                            <div class="portlet-body">
                                ...
                                <div id="printer">
                                    <div class="col-lg-9">
                                        <h3><?php echo get_phrase('purchases_outstandings'); ?> Invoice # <?=$purchase_no?></h3>
                                        <hr>
                                ...
                                <!-- /.row -->
                                    ...
                                    <div class="col-lg-3">
                                        <a href="<?php echo base_url().'manager/purchases/view' ?>" class="btn btn-default"><i class="fa fa-arrow-circle-left"></i> <?php echo get_phrase('back_to_purchases'); ?></a>
                                        <hr>
                                    ...
                                    <hr>
                                        ...
                                        <ul class="nav nav-pills nav-stacked">
                                            <li><a href="<?php echo base_url().'manager/sales/view' ?>"><?php echo get_phrase('sales'); ?></a>
                                            </li>
                                            <li><a href="<?php echo base_url().'manager/purchases/sales' ?>"><?php echo get_phrase('purchases'); ?></a>
                                            </li>
