                        ...
                        <div class="portlet portlet-default">
                            <div class="portlet-body">
                                ...
                                <!-- /.row -->
                                    ...
                                    <div class="col-lg-3">
                                        <a href="<?php echo base_url().'manager/sales/view' ?>" class="btn btn-default"><i class="fa fa-arrow-circle-left"></i> <?php echo get_phrase('back_to_sales'); ?></a>
                                        <hr>
                                    ...
                                    <hr />
                                        ...
                                        <ul class="nav nav-pills nav-stacked">
                                            <li><a href="<?php echo base_url().'manager/purchases/view' ?>"><?php echo get_phrase('purchases'); ?></a>
                                            </li>
                                            
                                            <li><a href="<?php echo base_url().'manager/outstandings/sales' ?>"><?php echo get_phrase('sales_outstandings'); ?></a>
                                            </li>
                                            <li><a href="<?php echo base_url().'manager/stock/view' ?>"><?php echo get_phrase('manage_stock'); ?></a>
                                            </li>
                                            <li><a href="<?php echo base_url().'manager/category/view' ?>"><?php echo get_phrase('manage_category'); ?></a>
                                            </li>
                                            <li><a href="<?php echo base_url().'manager/descriptions/view' ?>"><?php echo get_phrase('manage_descriptions'); ?></a>
                                            </li>
                                        </ul>
                                    </div>
