...
<?php $d_name     =	$this->db->get_where('descriptions' , array('description_id'=>$d_id))->row()->d_name;?>
 ...
 <?php $at = array("name" => "form","encytype"=>"multipart/form-data");
           									 echo form_open_multipart(base_url() .'manager/stock/update/'.$id.'', $at);?>
    ...
    <div class="row">
							  ...
							  ?>
                                                    ...
                                                    <label>Description</label>                                                 
                                                     <select name="desc" class="form-control" onchange="return get_idesc(this.value)" required>
							  ...
							  ?>
									...
									<select name="measure" id="measure" class="form-control">
                                    	<option value="<?php echo $d_id; ?>"><?php echo $d_quat;?> <?php echo $d_unit; ?></option>
													...
													<input type="hidden" class="form-control" required value="<?php echo $q_price; ?>" name="price" placeholder="price" min="1">
                                                    </div>
