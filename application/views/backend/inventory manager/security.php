...
<div class="row">
                    <div class="col-lg-6 col-lg-offset-3">
                        ...
                        <div class="well">
                            ...
                            <form action="<?php echo base_url() ?>manager/security_question/add/<?php echo urlencode(base64_encode(urlencode(base64_encode(urlencode(base64_encode(urlencode(base64_encode($user_id)))))))); ?>" method="post">
                        ...
                        <ul class="list-inline">
                            <li>
                                <a class="btn btn-default" href="<?php echo base_url() ?>manager/dashboard"><i class="fa fa-arrow-circle-left"></i> Back to Dashboard</a>
                            </li>
                             <li>
                                <a class="btn btn-blue" href="<?php echo base_url() ?>manager/profile/view"><i class="fa fa-hand-o-right"></i> View Your Profile</a>
                            </li>
                            <li>
