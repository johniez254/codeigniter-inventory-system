...
?>
 <div class="row">
                    ...
                    <div class="col-lg-8">
                      ...
                      <div class="btn-group">
                                        ...
                                        <ul class="dropdown-menu" role="menu">
                                            <li><a href="#" onclick="showAjaxModal('<?php echo base_url();?>manager/events/edit/<?php echo $id;?>');"><small><i class="fa fa-edit"></i> Edit</small></a>
                                            </li>
                                            <li><a href="#" onclick="confirm_modal('<?php echo base_url();?>manager/events/delete/<?php echo $id;?>');"><small><i class="fa fa-trash-o"></i> Delete</small></a>
                                            </li>
                                        </ul>
                                    </div>
                                    <!-- /btn-group -->
            ...
            echo form_open("manager/events/add_event", $attributes);?>
