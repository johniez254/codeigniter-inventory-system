                            ...
                            <div class="portlet-heading">
                                ...
                                <div class="portlet-widgets">
                                    <ul id="myTab" class="list-inline tabbed-portlets">
                                        <li class="active"><a class="btn btn-sm btn-green" href="#general" data-toggle="tab"><?php echo get_phrase('general_settings');?></a>
                                        </li>
                                        <li><a class="btn btn-sm btn-green" href="#language" data-toggle="tab"><?php echo get_phrase('language_settings');?></a>
                                        </li>
                                    </ul>
                ...
                <div class="row">
                    <div class="col-lg-12">
                                ...
                                <ul id="myPills" class="nav nav-pills" style="background-color:#f5f5f5;">
                                    <li class="active"><a href="#pillHome" data-toggle="tab"><i class="fa fa-list-ul"></i> <?php echo get_phrase('language_list');?></a>
                                    </li>
                                    <li><a href="#pillProfile" data-toggle="tab"><i class="fa fa-plus-circle"></i> <?php echo get_phrase('add_phrase'); ?></a>
                                    </li>
                                    <li><a href="#pillLanguage" data-toggle="tab"><i class="fa fa-plus-circle"></i> <?php echo get_phrase('add_language');?></a>
                                    </li>
                                </ul>
                ...
                <table cellpadding="0" cellspacing="0" border="0" class="table table-normal" >
                    ...
                    <tbody>
						...
						for($i = 1; $i<= 13; $i++):
							...
							else if($i	==	5)$type	=	'language';
							else if($i	==	6)$type	=	'login';
							else if($i	==	7)$type	=	'orders';
							else if($i	==	8)$type	=	'order_item';
							else if($i	==	9)$type	=	'profiles';
							else if($i	==	10)$type	=	'purchases';
							else if($i	==	11)$type	=	'settings';
							else if($i	==	12)$type	=	'stock';
							else if($i	==	13)$type	=	'supplier';
