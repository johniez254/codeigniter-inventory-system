                    ...
                    <div class="col-lg-12">
                        <div class="portlet portlet-default">
                            ...
                            <div id="areaChart" class="panel-collapse collapse in">
                                ...
                                <form class="form-inline" role="form" method="get" action="<?php echo base_url().'admin/reports/events_reports' ?>">
									  ...
									  $query = $this->db->query("select * from events where posted_by='admin' AND event_date BETWEEN ".$d1." and ".$d2."");
